...
def MoveQueens(current_board, counter, restart_counter, b_size, fail_count):
    ...
    if parent_h != 0:
        ...
        if value < parent_h:
            ...
            print("Move")
            print(child_board)
            return MoveQueens(child_board, counter + 1, restart_counter, b_size, fail_count)
        else:
            ...
            print("Restart Board")
            print(restart_board)
            return MoveQueens(restart_board, counter + 1, restart_counter + 1, b_size, fail_count + 1)
    else:
        print("Reached Goal")
...
def GenerateBoard():
    ...
    while counter_avg > 0:
        ...
        print("Initial Board")
        print(current_board)
        steps_count, goal_test, restart_count, fails = MoveQueens(current_board, 1, 0, BoardSize, fail_counter)
        if goal_test == "G":
